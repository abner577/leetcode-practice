...
public class CourseScheduleIIPrac5 {
    ...
    private boolean dfs(int current, List<List<Integer>>
            graph, List<Integer> ordering, int[] visited) {
        ...
        for(int neighbor : neighbors) {
            if(!dfs(neighbor, graph, ordering, visited)) return false;
        }
